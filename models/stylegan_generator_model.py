...
_STYLEGAN_PTH_VARS_TO_TF_VARS = {
    ...
    # [1, 1, 128, 128]
    'synthesis.layer10.epilogue.apply_noise.noise': 'noise10',
    # [1, 1, 128, 128]
    'synthesis.layer11.epilogue.apply_noise.noise': 'noise11',
    # [1, 1, 256, 256]
    'synthesis.layer12.epilogue.apply_noise.noise': 'noise12',
    # [1, 1, 256, 256]
    'synthesis.layer13.epilogue.apply_noise.noise': 'noise13',
    # [1, 1, 512, 512]
    'synthesis.layer14.epilogue.apply_noise.noise': 'noise14',
    # [1, 1, 512, 512]
    'synthesis.layer15.epilogue.apply_noise.noise': 'noise15',
    # [1, 1, 1024, 1024]
    'synthesis.layer16.epilogue.apply_noise.noise': 'noise16',
    # [1, 1, 1024, 1024]
    'synthesis.layer17.epilogue.apply_noise.noise': 'noise17',
    ...
    # [512]
    'synthesis.layer0.epilogue.apply_noise.weight': '4x4/Const/Noise/weight',
    'synthesis.layer0.epilogue.bias': '4x4/Const/bias',  # [512]
    # [1024, 512]
    'synthesis.layer0.epilogue.style_mod.dense.linear.weight': '4x4/Const/StyleMod/weight',
    # [1024]
    'synthesis.layer0.epilogue.style_mod.dense.wscale.bias': '4x4/Const/StyleMod/bias',
    'synthesis.layer1.conv.weight': '4x4/Conv/weight',  # [512, 512, 3, 3]
    # [512]
    'synthesis.layer1.epilogue.apply_noise.weight': '4x4/Conv/Noise/weight',
    'synthesis.layer1.epilogue.bias': '4x4/Conv/bias',  # [512]
    # [1024, 512]
    'synthesis.layer1.epilogue.style_mod.dense.linear.weight': '4x4/Conv/StyleMod/weight',
    # [1024]
    'synthesis.layer1.epilogue.style_mod.dense.wscale.bias': '4x4/Conv/StyleMod/bias',
    'synthesis.layer2.conv.weight': '8x8/Conv0_up/weight',  # [512, 512, 3, 3]
    # [512]
    'synthesis.layer2.epilogue.apply_noise.weight': '8x8/Conv0_up/Noise/weight',
    'synthesis.layer2.epilogue.bias': '8x8/Conv0_up/bias',  # [512]
    # [1024, 512]
    'synthesis.layer2.epilogue.style_mod.dense.linear.weight': '8x8/Conv0_up/StyleMod/weight',
    # [1024]
    'synthesis.layer2.epilogue.style_mod.dense.wscale.bias': '8x8/Conv0_up/StyleMod/bias',
    'synthesis.layer3.conv.weight': '8x8/Conv1/weight',  # [512, 512, 3, 3]
    # [512]
    'synthesis.layer3.epilogue.apply_noise.weight': '8x8/Conv1/Noise/weight',
    'synthesis.layer3.epilogue.bias': '8x8/Conv1/bias',  # [512]
    # [1024, 512]
    'synthesis.layer3.epilogue.style_mod.dense.linear.weight': '8x8/Conv1/StyleMod/weight',
    # [1024]
    'synthesis.layer3.epilogue.style_mod.dense.wscale.bias': '8x8/Conv1/StyleMod/bias',
    # [512, 512, 3, 3]
    'synthesis.layer4.conv.weight': '16x16/Conv0_up/weight',
    # [512]
    'synthesis.layer4.epilogue.apply_noise.weight': '16x16/Conv0_up/Noise/weight',
    'synthesis.layer4.epilogue.bias': '16x16/Conv0_up/bias',  # [512]
    # [1024, 512]
    'synthesis.layer4.epilogue.style_mod.dense.linear.weight': '16x16/Conv0_up/StyleMod/weight',
    # [1024]
    'synthesis.layer4.epilogue.style_mod.dense.wscale.bias': '16x16/Conv0_up/StyleMod/bias',
    'synthesis.layer5.conv.weight': '16x16/Conv1/weight',  # [512, 512, 3, 3]
    # [512]
    'synthesis.layer5.epilogue.apply_noise.weight': '16x16/Conv1/Noise/weight',
    'synthesis.layer5.epilogue.bias': '16x16/Conv1/bias',  # [512]
    # [1024, 512]
    'synthesis.layer5.epilogue.style_mod.dense.linear.weight': '16x16/Conv1/StyleMod/weight',
    # [1024]
    'synthesis.layer5.epilogue.style_mod.dense.wscale.bias': '16x16/Conv1/StyleMod/bias',
    # [512, 512, 3, 3]
    'synthesis.layer6.conv.weight': '32x32/Conv0_up/weight',
    # [512]
    'synthesis.layer6.epilogue.apply_noise.weight': '32x32/Conv0_up/Noise/weight',
    'synthesis.layer6.epilogue.bias': '32x32/Conv0_up/bias',  # [512]
    # [1024, 512]
    'synthesis.layer6.epilogue.style_mod.dense.linear.weight': '32x32/Conv0_up/StyleMod/weight',
    # [1024]
    'synthesis.layer6.epilogue.style_mod.dense.wscale.bias': '32x32/Conv0_up/StyleMod/bias',
    'synthesis.layer7.conv.weight': '32x32/Conv1/weight',  # [512, 512, 3, 3]
    # [512]
    'synthesis.layer7.epilogue.apply_noise.weight': '32x32/Conv1/Noise/weight',
    'synthesis.layer7.epilogue.bias': '32x32/Conv1/bias',  # [512]
    # [1024, 512]
    'synthesis.layer7.epilogue.style_mod.dense.linear.weight': '32x32/Conv1/StyleMod/weight',
    # [1024]
    'synthesis.layer7.epilogue.style_mod.dense.wscale.bias': '32x32/Conv1/StyleMod/bias',
    # [256, 512, 3, 3]
    'synthesis.layer8.conv.weight': '64x64/Conv0_up/weight',
    # [256]
    'synthesis.layer8.epilogue.apply_noise.weight': '64x64/Conv0_up/Noise/weight',
    'synthesis.layer8.epilogue.bias': '64x64/Conv0_up/bias',  # [256]
    # [512, 512]
    'synthesis.layer8.epilogue.style_mod.dense.linear.weight': '64x64/Conv0_up/StyleMod/weight',
    # [512]
    'synthesis.layer8.epilogue.style_mod.dense.wscale.bias': '64x64/Conv0_up/StyleMod/bias',
    'synthesis.layer9.conv.weight': '64x64/Conv1/weight',  # [256, 256, 3, 3]
    # [256]
    'synthesis.layer9.epilogue.apply_noise.weight': '64x64/Conv1/Noise/weight',
    'synthesis.layer9.epilogue.bias': '64x64/Conv1/bias',  # [256]
    # [512, 512]
    'synthesis.layer9.epilogue.style_mod.dense.linear.weight': '64x64/Conv1/StyleMod/weight',
    # [512]
    'synthesis.layer9.epilogue.style_mod.dense.wscale.bias': '64x64/Conv1/StyleMod/bias',
    # [128, 256, 3, 3]
    'synthesis.layer10.conv.weight': '128x128/Conv0_up/weight',
    # [128]
    'synthesis.layer10.epilogue.apply_noise.weight': '128x128/Conv0_up/Noise/weight',
    'synthesis.layer10.epilogue.bias': '128x128/Conv0_up/bias',  # [128]
    # [256, 512]
    'synthesis.layer10.epilogue.style_mod.dense.linear.weight': '128x128/Conv0_up/StyleMod/weight',
    # [256]
    'synthesis.layer10.epilogue.style_mod.dense.wscale.bias': '128x128/Conv0_up/StyleMod/bias',
    # [128, 128, 3, 3]
    'synthesis.layer11.conv.weight': '128x128/Conv1/weight',
    # [128]
    'synthesis.layer11.epilogue.apply_noise.weight': '128x128/Conv1/Noise/weight',
    'synthesis.layer11.epilogue.bias': '128x128/Conv1/bias',  # [128]
    # [256, 512]
    'synthesis.layer11.epilogue.style_mod.dense.linear.weight': '128x128/Conv1/StyleMod/weight',
    # [256]
    'synthesis.layer11.epilogue.style_mod.dense.wscale.bias': '128x128/Conv1/StyleMod/bias',
    # [64, 128, 3, 3]
    'synthesis.layer12.conv.weight': '256x256/Conv0_up/weight',
    # [64]
    'synthesis.layer12.epilogue.apply_noise.weight': '256x256/Conv0_up/Noise/weight',
    'synthesis.layer12.epilogue.bias': '256x256/Conv0_up/bias',  # [64]
    # [128, 512]
    'synthesis.layer12.epilogue.style_mod.dense.linear.weight': '256x256/Conv0_up/StyleMod/weight',
    # [128]
    'synthesis.layer12.epilogue.style_mod.dense.wscale.bias': '256x256/Conv0_up/StyleMod/bias',
    'synthesis.layer13.conv.weight': '256x256/Conv1/weight',  # [64, 64, 3, 3]
    # [64]
    'synthesis.layer13.epilogue.apply_noise.weight': '256x256/Conv1/Noise/weight',
    'synthesis.layer13.epilogue.bias': '256x256/Conv1/bias',  # [64]
    # [128, 512]
    'synthesis.layer13.epilogue.style_mod.dense.linear.weight': '256x256/Conv1/StyleMod/weight',
    # [128]
    'synthesis.layer13.epilogue.style_mod.dense.wscale.bias': '256x256/Conv1/StyleMod/bias',
    # [32, 64, 3, 3]
    'synthesis.layer14.conv.weight': '512x512/Conv0_up/weight',
    # [32]
    'synthesis.layer14.epilogue.apply_noise.weight': '512x512/Conv0_up/Noise/weight',
    'synthesis.layer14.epilogue.bias': '512x512/Conv0_up/bias',  # [32]
    # [64, 512]
    'synthesis.layer14.epilogue.style_mod.dense.linear.weight': '512x512/Conv0_up/StyleMod/weight',
    # [64]
    'synthesis.layer14.epilogue.style_mod.dense.wscale.bias': '512x512/Conv0_up/StyleMod/bias',
    'synthesis.layer15.conv.weight': '512x512/Conv1/weight',  # [32, 32, 3, 3]
    # [32]
    'synthesis.layer15.epilogue.apply_noise.weight': '512x512/Conv1/Noise/weight',
    'synthesis.layer15.epilogue.bias': '512x512/Conv1/bias',  # [32]
    # [64, 512]
    'synthesis.layer15.epilogue.style_mod.dense.linear.weight': '512x512/Conv1/StyleMod/weight',
    # [64]
    'synthesis.layer15.epilogue.style_mod.dense.wscale.bias': '512x512/Conv1/StyleMod/bias',
    # [16, 32, 3, 3]
    'synthesis.layer16.conv.weight': '1024x1024/Conv0_up/weight',
    # [16]
    'synthesis.layer16.epilogue.apply_noise.weight': '1024x1024/Conv0_up/Noise/weight',
    'synthesis.layer16.epilogue.bias': '1024x1024/Conv0_up/bias',  # [16]
    # [32, 512]
    'synthesis.layer16.epilogue.style_mod.dense.linear.weight': '1024x1024/Conv0_up/StyleMod/weight',
    # [32]
    'synthesis.layer16.epilogue.style_mod.dense.wscale.bias': '1024x1024/Conv0_up/StyleMod/bias',
    # [16, 16, 3, 3]
    'synthesis.layer17.conv.weight': '1024x1024/Conv1/weight',
    # [16]
    'synthesis.layer17.epilogue.apply_noise.weight': '1024x1024/Conv1/Noise/weight',
    'synthesis.layer17.epilogue.bias': '1024x1024/Conv1/bias',  # [16]
    # [32, 512]
    'synthesis.layer17.epilogue.style_mod.dense.linear.weight': '1024x1024/Conv1/StyleMod/weight',
    # [32]
    'synthesis.layer17.epilogue.style_mod.dense.wscale.bias': '1024x1024/Conv1/StyleMod/bias',
        ...
        for pth_var_name, tf_var_name in _STYLEGAN_PTH_VARS_TO_TF_VARS.items():
            if 'Conv0_up' in tf_var_name:
                ...
                if ((self.fused_scale is True) or
                    ...
                    pth_var_name = pth_var_name.replace(
                        'conv.weight', 'weight')
...
class MappingModule(nn.Sequential):
    ...
    def __init__(self,
        ...
        for i in range(num_layers):
            ...
            out_dim = final_space_dim if i == (
                num_layers - 1) else hidden_space_dim
        ...
        for block_idx in range(1, len(self.channels)):
            if block_idx + lod < len(self.channels):
                ...
                if layer_idx == 0:
                    ...
                    x = self.__getattr__(f'layer{layer_idx}')(
                        x, w[:, layer_idx])
...
class EpilogueBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.apply_noise = NoiseApplyingLayer(
            layer_idx, channels, randomize_noise)
